...
Assuming that the user has Python 2.7+, pytesseract, and tesseract installed, run the following command on the command line in the same directory as {\tt driver.py}.

{\tt \$python driver.py \{path-to-image-file\} \{list of target languages separated by single space\}}\\
